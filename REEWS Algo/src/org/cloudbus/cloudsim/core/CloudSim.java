...
public class CloudSim {
	...
	public static void init(int numUser, Calendar cal, boolean traceFlag) {
		try {
			...
			Log.printLine("CloudSim.init(): The simulation has been terminated due to an unexpected error"+s);
			Log.printLine(s.getMessage());
		} catch (Exception e) {
			Log.printLine("CloudSim.init(): The simulation has been terminated due to an unexpected error"+e);
