...
import org.workflowsim.planning.REEWSPlanningAlgorithm;
import org.workflowsim.planning.IREEWSPlanningAlgorithm;
    ...
    private BasePlanningAlgorithm getPlanningAlgorithm(PlanningAlgorithm name) {
        ...
        switch (name) {
            ...
            case DHEFT:
                ...
                break;
            case IREEWS:
                planner = new IREEWSPlanningAlgorithm();
                break;
            case REEWS:
                planner = new REEWSPlanningAlgorithm();
                break;
            default:
                planner = null;
                break;
